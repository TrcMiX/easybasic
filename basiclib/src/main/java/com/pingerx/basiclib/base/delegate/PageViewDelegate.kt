package com.pingerx.basiclib.base.delegate
...
import com.pingerx.basiclib.app.BaseApplication
import com.pingerx.basiclib.base.activity.BaseActivity
import com.pingerx.basiclib.base.fragment.BaseFragment
import com.pingerx.basiclib.utils.AppUtils
import com.pingerx.basiclib.utils.StatusBarUtils
import com.pingerx.basiclib.utils.ToastUtils
import com.pingerx.basiclib.utils.ViewUtils
import com.pingerx.basiclib.widget.dialog.MaterialConfirmDialog
import com.pingerx.basiclib.widget.dialog.MaterialLoadingDialog
import com.pingerx.basiclib.widget.dialog.MaterialTipsDialog
import com.pingerx.basiclib.widget.placeholder.PlaceholderView

/**
 * @author Pinger
 * @since 2019/2/19 16:30
 *
...
class PageViewDelegate(private val view: View?) {
    ...
    fun setToolbarPadding(toolbar: Toolbar?) {
        if (toolbar != null) {
            val params = toolbar.layoutParams as ViewGroup.LayoutParams
            params.height = StatusBarUtils.getStatusBarHeight() + StatusBarUtils.getToolbarHeight(toolbar.context)
            toolbar.layoutParams = params
            toolbar.setPadding(0, StatusBarUtils.getStatusBarHeight(), 0, 0)
        }
    }
