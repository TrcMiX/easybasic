...
abstract class BaseNavFragment : BaseFragment() {
     ...
     * 支持滑动返回
     */
    override fun isSwipeBackEnable() = !isMainPage()
    ...
    protected fun setPageTitle(title: String?) {
        setPageTitle(toolbar, title)
    }

    protected fun setPageTitle(toolbar: Toolbar, title: String?) {
        mDelegate.setPageTitle(toolbar, title)
    }
