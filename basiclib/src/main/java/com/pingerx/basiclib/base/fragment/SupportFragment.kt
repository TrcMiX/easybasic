...
open class SupportFragment : Fragment(), ISupportFragment, ISwipeBackFragment {
    ...
    fun startFragment(toFragment: ISupportFragment) {
     ...
     */
    fun startFragment(toFragment: ISupportFragment, @ISupportFragment.LaunchMode launchMode: Int) {
     ...
     */
    fun startFragmentForResult(toFragment: ISupportFragment, requestCode: Int) {
     ...
     */
    fun startFragmentWithPop(toFragment: ISupportFragment) {
     ...
     * @see .start
     */
    fun startFragmentWithPopTo(toFragment: ISupportFragment, targetFragmentClass: Class<*>, includeTargetFragment: Boolean) {
