package com.pingerx.basiclib.base.recycler
...
import com.pingerx.basiclib.base.recycler.header.RecyclerClassicsFooter
import com.pingerx.basiclib.base.recycler.header.RecyclerProgressFooter
import com.pingerx.basiclib.base.recycler.header.material.MaterialHeader
import com.pingerx.basiclib.base.recycler.multitype.MultiTypeAdapter
import com.pingerx.basiclib.base.recycler.multitype.MultiTypeViewHolder
import com.pingerx.basiclib.base.recycler.multitype.OneToManyFlow
...
abstract class BaseMultiRecyclerNavActivity<P : BaseRecyclerPresenter<*>> : BaseNavActivity(), BaseRecyclerContract.View {
    ...
    protected open fun getRefreshFooter(): RefreshFooter {
        return RecyclerProgressFooter(this)
    }
